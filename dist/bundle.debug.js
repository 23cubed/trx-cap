/* TRX Capital Bundle (Debug) - Built: 2025-07-07T02:55:22.621Z */
var TRXCap = (() => {
  ...
  function pageLoadScene() {
    ...
    tl.addLabel("pageLoader", 0).addLabel("heroAnimate", 0.4).addLabel("heroContentAnimate", 0.75).to(".page-loader", {
      opacity: 0,
      duration: 0.8,
      ease: "power4.out",
      onComplete: () => {
    ...
    }, null, "heroContentAnimate").fromTo(
      "#hero .hero-cta",
      { opacity: 0 },
      {
        opacity: 1,
